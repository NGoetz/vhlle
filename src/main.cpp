...
double etaS, zetaS0, eCrit, etaS0, eps0, ahr, al, ah, rhodecay, T0, D, E, F, zwidth;
int icModel,
    glauberVariable =
...
void readParameters(char *parFile) {
 ...
 while (fin.good()) {
  ...
  if (strcmp(parName, "eosType") == 0)
   ...
   etaS = atof(parValue);
  else if (strcmp(parName, "etaS0") == 0)
   etaS0 = atof(parValue);
  else if (strcmp(parName, "eps0") == 0)
   eps0 = atof(parValue);
  else if (strcmp(parName, "ahr") == 0)
   ahr = atof(parValue);
   ...
   zetaS0 = atof(parValue);
  else if (strcmp(parName, "zwidth") == 0)
    zwidth = atof(parValue);
...
void printParameters() {
 ...
 cout << "E = " << E << endl;
 cout << "F =  " << F << endl;
 cout << "zeta/s max = " << zetaS0 << endl;
 cout << "zeta/s width = " << zwidth << endl;
...
int main(int argc, char **argv) {
 ...
 Hydro *h;
 time_t start = 0, end;
std::cout<<"run updated version"<<std::endl;
 time(&start);
 ...
 trcoeff = new TransportCoeff(etaS, zetaS0,etaS0, eps0, ahr, ah, al, rhodecay, T0, D, E, F, zwidth, eos);
